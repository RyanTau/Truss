...
- Home Assistant **2026.9 or later**, with an Assist-compatible microphone (Companion app, Voice device, ESPHome satellite, etc.). Earlier versions have not been targeted.
