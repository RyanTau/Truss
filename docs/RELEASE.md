...
4. Install in isolated HA 2025.11 and current-release instances. Test config/options flow, MCP detection, invalid tokens, unload/reload, expired token recovery, startup retries, and entity exposure changes.
