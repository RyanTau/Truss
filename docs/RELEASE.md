...
4. Install in an isolated HA 2026.9+ instance. Test config/options flow, MCP detection, invalid tokens, unload/reload, expired token recovery, startup retries, and entity exposure changes.
